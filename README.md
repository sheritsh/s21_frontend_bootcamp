...
Перед началом изучения ознакомьтесь с [инструкцией](./materials/Instructions.md) и убедитесь, что у вас установлены все необходимые инструменты для выполнения заданий.
...
[В файле задания](./src//chapter_4/sudoku.js) представлены тестовые данные для вашей функции, они имеют 3 уровня сложности:
...
>Пожалуйста, оставьте обратную связь по проекту в [форме обратной связи.](https://forms.gle/5ZosYijTzUKH9H7M6)
